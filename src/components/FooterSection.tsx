            ...
            <div className="relative">
              ...
              <div className="relative bg-black/40 backdrop-blur-xl border border-cyan-400/20 rounded-3xl p-8 shadow-2xl">
                <h3 className="text-2xl font-bold text-white mb-6 flex items-center">
                  <div className="w-8 h-8 bg-bg-cyan-300/25 rounded-lg mr-3 flex items-center justify-center">
                    <svg
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <button
                    type="submit"
                    className="w-full relative group bg-cyan-300/25 hover:from-cyan-600 hover:to-blue-600 text-white font-semibold py-4 px-6 rounded-xl transition-all duration-300 transform hover:scale-105 hover:shadow-2xl"
                  >
                    <div className="absolute inset-0 bg-cyan-300/25 rounded-xl blur opacity-0 group-hover:opacity-30 transition-opacity"></div>
              ...
              <div className="relative">
                ...
                <div className="relative bg-black/40 backdrop-blur-xl border border-purple-400/20 rounded-3xl p-8 shadow-2xl">
                  ...
                  <p className="text-gray-300 text-center mb-8 leading-relaxed">
                    ...
                    saran, atau kritik. Jika anda ingin membuat sebuah proyek,
                    jangan ragu untuk menghubungi saya. Saya siap membantu anda.
                  </p>
